...
\begin{itemize}[leftmargin=2em]
  ...
  \item \textbf{PO-6 (Structural UTXO-domain/value preservation):} valid structural block application preserves a duplicate-free UTXO domain below the next fresh-id bound and cannot increase total UTXO value, assuming the pre-state domain is duplicate-free and below the current fresh-id base.
  Machine-checked as \texttt{apply\_valid\_block\_structural\_preserves\_domain\_nodup} and \texttt{apply\_valid\_block\_structural\_preserves\_total\_value}, with transaction-level preservation discharged by \texttt{delta\_tx\_preserves\_domain\_nodup}, \texttt{delta\_tx\_preserves\_domain\_bound}, and \texttt{delta\_tx\_preserves\_total\_value}.
