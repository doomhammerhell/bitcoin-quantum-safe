...
Definition extract_utxo_total_value := utxo_total_value.
Definition extract_legacy_utxo_count := legacy_utxo_count.
Definition extract_legacy_tx_output_count := legacy_tx_output_count.
Definition extract_frozen_utxo_count := frozen_utxo_count.
Definition extract_accepted_block_inputs_pq_or_missing := accepted_block_inputs_pq_or_missing.
