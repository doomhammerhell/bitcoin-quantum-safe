...
|---|---|---|
| Invariant preservation | Thm 3, 4 | TLA+/TLC (2 models, zero violations) + Coq structural UTXO-domain preservation theorem/refinement witnesses |
...
| PO-6 | Invariant preservation | **Model-checked + structural Coq invariant theorem + operational refinement evidence** | TLA+/TLC + Coq `apply_valid_block_structural_preserves_domain_nodup` + Coq-extracted/Rust invariant witnesses + release-binary certificate |
...
# Validate compiled PO-6 UTXO-domain invariant witnesses against Coq extraction
...
| Compiled-artifact refinement | 7 | Release-binary validation against Coq-extracted PO-8, PO-4 transcript, PO-5 txid, transition, TransitionKernel per-case report witnesses, PO-6 UTXO-domain invariant witnesses, plus runtime txid/store references |
