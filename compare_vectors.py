...
def main():
    ...
    # Load optional exhaustive varint / witness refinement summaries when generated by
    # build_extraction.sh. Keeping this optional preserves hermetic local vector
    # comparison for the checked-in baseline.
    coq_varint = None
    rust_varint = None
    coq_witness = None
    rust_witness = None
