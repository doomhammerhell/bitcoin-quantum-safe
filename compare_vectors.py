...
def main():
    ...
    # Load optional exhaustive varint / witness / sighash / transition refinement summaries when
    ...
    if coq_transition is not None:
        ...
        print("      Run ./verify_transition_refinement.sh for release-binary transition validation")
    print()
    ...
    if coq_transition is not None:
        ...
        print("  PO-5 (Compiled artifact):  RUN ./verify_transition_refinement.sh FOR RELEASE-BINARY TRANSITION VALIDATION")
    else:
